...
class ResNet(object):
    ...
    def _build_model(self):
        ...
        with tf.compat.v1.variable_scope("costs"):
            ...
            self.cost = tf.reduce_mean(input_tensor=xent, name="xent")
    ...
    def _build_train_op(self):
        ...
        self.lrn_rate = tf.compat.v1.train.piecewise_constant(self.global_step,
                                                    boundaries, values)
    ...
    def _batch_norm(self, name, x):
        ...
        with tf.compat.v1.variable_scope(name):
            ...
            if self.mode == "train":
                mean, variance = tf.nn.moments(x=x, axes=[0, 1, 2], name="moments")
    ...
    def _residual(self,
        ...
        with tf.compat.v1.variable_scope("sub_add"):
            if in_filter != out_filter:
                ...
                orig_x = tf.pad(
                    tensor=orig_x,
                    paddings=[[0, 0], [0, 0], [0, 0], [(out_filter - in_filter) // 2,
    ...
    def _decay(self):
        ...
        return self.hps.weight_decay_rate
    ...
    def _fully_connected(self, x, out_dim):
        ...
        b = tf.compat.v1.get_variable(
            "biases", [out_dim], initializer=tf.compat.v1.constant_initializer())
