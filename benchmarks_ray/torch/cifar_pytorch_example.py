...
class CifarTrainingOperator(TrainingOperator):
    ...
    def setup(self, config):
        ...
        #if config["test_mode"]:
        train_dataset = Subset(train_dataset, list(range(20000)))
        validation_dataset = Subset(validation_dataset, list(range(10000)))
...
if __name__ == "__main__":
    ...
    ray.init(address="auto", num_cpus=num_cpus, log_to_driver=True)
