...
def serve_new_model(model_dir, checkpoint, config, metrics, day,
    ...
    client.create_backend("mnist", MNISTDeployment, checkpoint_path, config, metrics, use_gpu, config=config, ray_actor_options=resource_config)
    client.create_endpoint("mnist", backend="mnist", route="/mnist")
